...
function StETH() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetch(
        "https://api.coingecko.com/api/v3/coins/lido-staked-ether?localization=false"
      );
  ...
  if (!coin) {
    return (
      <div className="btc-loading">
        ...
        <p>Loading Lido Staked Ether data...</p>
      </div>
    );
  }
  ...
  return (
    <div className="btc-container">
      {/* Same JSX layout as Bitcoin.jsx but with coin data dynamically filled */}
      <div className="btc-left">
        <h2 className="btc-title">About Lido Staked Ether</h2>
      ...
      <div className="btc-right">
        <div className="btc-price-row">
          <h1 className="btc-price">
            STETH - ₹{coin.market_data.current_price.inr.toLocaleString()}
          </h1>
          <span
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                ...
                {coin.market_data.circulating_supply.toLocaleString()} STETH
              </li>
              <li>
                <strong>Total Supply:</strong>{" "}
                {coin.market_data.total_supply?.toLocaleString() || "N/A"} STETH
              </li>
              <li>
