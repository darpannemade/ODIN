...
function Solana() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetch("https://api.coingecko.com/api/v3/coins/solana?localization=false");
  ...
  return (
    <div className="btc-container">
      <div className="btc-left">
        <h2 className="btc-title">About Solana</h2>
      ...
      <div className="btc-right">
        <div className="btc-price-row">
          <h1 className="btc-price">SOL - ₹{coin.market_data.current_price.inr.toLocaleString()}</h1>
        ...
        <div className="btc-chart-container">
          <TradingViewWidget symbol="BINANCE:SOLUSDT" />
        </div>
        <div className="btc-stats-grid">
          <div>
            ...
            <ul>
              ...
              <li><strong>Circulating Supply:</strong> {coin.market_data.circulating_supply.toLocaleString()} SOL</li>
              <li><strong>Total Supply:</strong> {coin.market_data.total_supply?.toLocaleString() || "N/A"} SOL</li>
