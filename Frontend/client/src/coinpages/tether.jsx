  ...
  return (
    <div className="btc-container">
      <div className="btc-left">
        <h2 className="btc-title">About Tether</h2>
        ...
        <div className="btc-explore-card">
          ...
          <Link to="/market" className="explore-btn">
            Explore →
          </Link>
        </div>
      </div>
      ...
      <div className="btc-right">
        <div className="btc-price-row">
          <h1 className="btc-price">
            USDT - ₹{coin.market_data.current_price.inr.toLocaleString()}
          </h1>
          <span
        ...
        <div className="btc-chart-container">
          <TradingViewWidget symbol="BINANCE:BNBUSDT" />
        </div>
        ...
        <div className="btc-stats-grid">
          <div>
            ...
            <ul>
              ...
              <li>
                <strong>Circulating Supply:</strong> {coin.market_data.circulating_supply.toLocaleString()} USDT
              </li>
              <li>
                <strong>Total Supply:</strong> {coin.market_data.total_supply?.toLocaleString() || "N/A"} USDT
              </li>
              <li>
