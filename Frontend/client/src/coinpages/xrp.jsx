  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetch(
        "https://api.coingecko.com/api/v3/coins/ripple?localization=false"
      );
  ...
  return (
    <div className="btc-container">
      <div className="btc-left">
        <h2 className="btc-title">About XRP</h2>
      ...
      <div className="btc-right">
        <div className="btc-price-row">
          <h1 className="btc-price">
            XRP - ₹{coin.market_data.current_price.inr.toLocaleString()}
          </h1>
          <span
            className={`btc-change ${
        ...
        <div className="btc-chart-container">
          <TradingViewWidget symbol="BITSTAMP:XRPUSD" />
        </div>
        ...
        <div className="btc-stats-grid">
          <div>
            ...
            <ul>
              <li>
                <strong>Market Cap:</strong> ₹{coin.market_data.market_cap.inr.toLocaleString()}
              </li>
              <li>
                <strong>24h Volume:</strong> ₹{coin.market_data.total_volume.inr.toLocaleString()}
              </li>
              <li>
                <strong>Circulating Supply:</strong> {coin.market_data.circulating_supply.toLocaleString()} XRP
              </li>
              <li>
                <strong>Total Supply:</strong> {coin.market_data.total_supply?.toLocaleString() || "N/A"} XRP
              </li>
              <li>
                <strong>All Time High:</strong> ₹{coin.market_data.ath.inr.toLocaleString()}
              </li>
            </ul>
          </div>
        </div>
