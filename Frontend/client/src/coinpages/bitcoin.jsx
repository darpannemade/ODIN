  ...
  return (
    <div className="btc-container">
      <div className="btc-left">
        <h2 className="btc-title">About Bitcoin</h2>
      ...
      <div className="btc-right">
        <div className="btc-price-row">
          <h1 className="btc-price">
            BTC - ₹{coin.market_data.current_price.inr.toLocaleString()}
          </h1>
          <span
        ...
        <div className="btc-stats-grid">
          <div>
            ...
            <ul>
              ...
              <li>
                <strong>Circulating Supply:</strong> {coin.market_data.circulating_supply.toLocaleString()} BTC
              </li>
              <li>
                <strong>Total Supply:</strong> {coin.market_data.total_supply?.toLocaleString() || "N/A"} BTC
              </li>
              <li>
