...
function Dogecoin() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetch("https://api.coingecko.com/api/v3/coins/dogecoin?localization=false");
  ...
  return (
    <div className="btc-container">
      <div className="btc-left">
        <h2 className="btc-title">About Dogecoin</h2>
      ...
      <div className="btc-right">
        <div className="btc-price-row">
          <h1 className="btc-price">DOGE - ₹{coin.market_data.current_price.inr.toLocaleString()}</h1>
        ...
        <div className="btc-chart-container">
          <TradingViewWidget symbol="BINANCE:DOGEUSDT" />
        </div>
        <div className="btc-stats-grid">
          <div>
            ...
            <ul>
              ...
              <li><strong>Circulating Supply:</strong> {coin.market_data.circulating_supply.toLocaleString()} DOGE</li>
              <li><strong>Total Supply:</strong> {coin.market_data.total_supply?.toLocaleString() || "N/A"} DOGE</li>
